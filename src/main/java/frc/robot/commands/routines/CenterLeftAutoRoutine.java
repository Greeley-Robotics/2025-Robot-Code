...
public class CenterLeftAutoRoutine extends Command {
  private final PWMDriveSubsystem driveSubsystem;
  private final PWMRollerSubsystem rollerSubsystem;
  private final Timer timer = new Timer();
  private boolean finished = false;

  public CenterLeftAutoRoutine(PWMDriveSubsystem driveSubsystem, PWMRollerSubsystem rollerSubsystem) {
  ...
  public void initialize() {
    System.out.println("Running Center Left Start Auto!");
    timer.restart();
    finished = false;
