...
public class CenterRightAutoRoutine extends Command {
  private final PWMDriveSubsystem driveSubsystem;
  private final PWMRollerSubsystem rollerSubsystem;
  private final Timer timer = new Timer();
  private boolean finished = false;

  public CenterRightAutoRoutine(PWMDriveSubsystem driveSubsystem, PWMRollerSubsystem rollerSubsystem) {
  ...
  public void initialize() {
    System.out.println("Running Center Right Start Auto!");
    timer.restart();
    finished = false;
